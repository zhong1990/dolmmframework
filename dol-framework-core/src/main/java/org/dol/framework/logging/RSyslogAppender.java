...
public class RSyslogAppender extends AppenderSkeleton {
    /**
     * Kernel messages
     */
    ...
    public RSyslogAppender() {
        this.initSyslogFacilityStr();
    }

    public RSyslogAppender(
            Layout layout, int syslogFacility) {
        this.layout = layout;
     ...
     *
     * @param facilityName one of the strings KERN, USER, MAIL, DAEMON, AUTH, SYSLOG,
    ...
    /**
     * Release any resources held by this RSyslogAppender.
     *
     * @since 0.8.4
     */
    ...
    /**
     * The RSyslogAppender requires a layout. Hence, this method returns
     * <code>true</code>.
     *
     * @since 0.8.4
     */
    ...
    public void setSyslogHost(final String syslogHost) {
        this.sqw = new SyslogQuietWriter(new RSyslogWriter(syslogHost),
