 ...
 * @since 0.7.3
 */
public class RSyslogWriter extends Writer {
     ...
     *                   following the name or IPv4 literal address with a colon and a
     *                   decimal port number. To specify a port with an IPv6 address,
     *                   enclose the IPv6 address in square brackets before appending
     *                   the colon and decimal port number.
     */
    public RSyslogWriter(
