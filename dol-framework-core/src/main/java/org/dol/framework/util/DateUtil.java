...
public class DateUtil {
    /**
     * @Fields PATTERN_YYYYMMDD : yyyyMMdd
     */
    public static final String PATTERN_YYYYMMDD = "yyyyMMdd";
    /**
     * @Fields PATTERN_YYYY : yyyy
     */
    public static final String PATTERN_YYYY = "yyyy";
    /**
     * @Fields PATTERN_YYYY_MM_DD_HH_MM_SS : yyyy-MM-dd HH:mm:ss
     */
    public static final String PATTERN_YYYY_MM_DD_HH_MM_SS = "yyyy-MM-dd HH:mm:ss";
    /**
     * @Fields PATTERN_YYYYMMDDHHMMSS : yyyyMMddHHmmss
     */
    public static final String PATTERN_YYYYMMDDHHMMSS = "yyyyMMddHHmmss";
    /**
     * @Fields PATTERN_YYYYMMDDHHMMSSFFF : yyyyMMddHHmmssfff
     */
    public static final String PATTERN_YYYYMMDDHHMMSSFFF = "yyyyMMddHHmmssfff";
    ...
    public static String getNextYear(String dateStr, int offset)
            throws ParseException {
        SimpleDateFormat sf = new SimpleDateFormat(PATTERN_YYYY);
        Date date = sf.parse(dateStr);
        Calendar c = Calendar.getInstance();
        c.setTime(date);
