...
public class StringUtil {
    ...
    public static List String2List(String p_Param, String p_Delim) {
        if (p_Param == null || p_Param.trim().equals(StringUtil.EMPTY_STRING)) {
            return null;
        }
    ...
    public static String formatMoney(double money) {
        return NUM_FORMAT.format(money).replaceAll("￥", StringUtil.EMPTY_STRING);
    }
     ...
     *            原包含小写数字的字符串
     * @return String
     * @author created by Henry, commented by dolphin
     * @since JDK 1.7
    ...
    public static String numberUpper(String str) {
        ...
        for (int i = 0; i < str.length(); i++) {
            char c = str.charAt(i);
            sb.append((c >= '0' && c <= '9') ? upperChars[c - '0'] : c + StringUtil.EMPTY_STRING);
        }
        return sb.toString();
    }
     ...
     * @return String
     * @throws NumberFormatException
     * @author henry, commented by dolphin
     * @since JDK 1.7
    ...
    public static String showMoney(int moneyType, String money) {
        ...
        if (money != null && !money.equalsIgnoreCase(StringUtil.EMPTY_STRING)) {
            String prefix = null;
            if (money.startsWith("-")) {
    ...
    public static String getIdsForSql(List idList) {
        ...
        if (idList != null && idList.size() > 0) {
            for (int i = 0; i < idList.size(); i++) {
                strBuf.append((0 == i) ? StringUtil.EMPTY_STRING : ",");
    ...
    /**
     * <p>
     * Checks if a String is whitespace, empty (StringUtil.EMPTY_STRING) or
     * null.
     * </p>
     *
     * <pre>
     * StringUtils.isBlank(null)      = true
     * StringUtils.isBlank(StringUtil.EMPTY_STRING)        = true
    ...
    /**
     * <p>
     * Checks if a String is not empty (StringUtil.EMPTY_STRING), not null and
     * not whitespace only.
     * </p>
     *
     * <pre>
     * StringUtils.isNotBlank(null)      = false
     * StringUtils.isNotBlank(StringUtil.EMPTY_STRING)        = false
    ...
    public static String dealTagOptionCode(String optionCode) throws Exception {
        ...
        if (null != optionCode && !StringUtil.EMPTY_STRING.equals(optionCode)) {
    ...
    public static String trim(String str) {
        return isBlank(str) ? StringUtil.EMPTY_STRING : str.trim();
    }
