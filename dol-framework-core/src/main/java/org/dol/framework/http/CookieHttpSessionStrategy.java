...
public final class CookieHttpSessionStrategy implements MultiHttpSessionStrategy, HttpSessionManager {
    ...
    // private String cookieNameForJSESSIONID = "JSESSIONID";
    ...
    /**
     * @Fields crossSubApplication : 是否跨子应用程序共享sessionId
     */
    private boolean crossSubApplication;
    ...
    private Cookie createSessionCookie(HttpServletRequest request,
        ...
        Cookie sessionCookie = new Cookie(cookieName, StringUtil.EMPTY_STRING);
        if (isServlet3Plus) {
...
//			if (StringUtil.isNotBlank(serverName) && StringUtil.isNotBlank(ip) && !serverName.equals(ip)) {
//				String[] ss = serverName.split("\\.");
//				if (ss.length > 2) {
//					String domain = serverName.substring(serverName.indexOf('.'));
...
//		}
    ...
    public Map<String, String> getSessionIds(HttpServletRequest request) {
        ...
        String sessionCookieValue = session == null ? StringUtil.EMPTY_STRING : session.getValue();
    ...
    public String encodeURL(String url, String sessionAlias) {
        ...
        String replacement = isDefaultAlias ? StringUtil.EMPTY_STRING : "$1" + encodedSessionAlias;
    ...
    public boolean isCrossSubApplication() {
        return crossSubApplication;
    }

    public void setCrossSubApplication(boolean crossSubApplication) {
        this.crossSubApplication = crossSubApplication;
    }
